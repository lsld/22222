...
$list = CrudDAO::readSubjectItemsForEachSubject($subject_name);
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($list as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?= $value['item_added_date_time'] ?></td>

                            <td><?= $value['username'] ?></td>

                            <td><?= $value['enroller'] ?></td>

                            <td><a href="<?php echo $value['item_url']; ?>" download="proposed_file_name">Download</a></td>

                            <td> <a href="editSubjectItems.php?id= <?php echo $value['item_id']; ?>" > </a></td>

                            <td> <a href="../process/deleteSubjectItemsProcess.php?id=<?php echo $value['item_id']; ?>"> Delete</a></td>
                        </tr>
