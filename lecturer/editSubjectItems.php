...
<div id="wrapper">
    ...
    <div class="container">
        ...
        $edit = CrudDAO::GetEditSubjectItems($id);
        ...
        <h2>Add New Subject Items</h2> <br/>
        ...
        <p>Fill the following details to add a subject item  to the course web:</p><br/> <br/>
        ...
        <form  id="registration-form"  method="post" action="../process/addnewsubjectitemprocess.php" name="edit_form">
            ...
            <div class="form-group green row form-center form_gap">
                ...
                <div class="col-md-5">
                    <input type="text" value="<?php echo $edit['item_name']; ?>" onpaste="return false;"
            ...
            <div class="form-group green row form-center form_gap">
                ...
                <div class="col-md-5">
                    <textarea  type="text" value="<?php echo $edit['item_description']; ?>" onpaste="return false;"
            ...
            <div class="form-group green row form-center form_gap">
                ...
                <div class="col-md-5">
                    <input type="text" onpaste="return false;"
                           class="form-control" name="item_url" placeholder="" maxlength="50" value="D:\Walllpapers\wallhaven-365180.jpg" required autofocus/>
                </div>
            </div>
            ...
            <div class="form-group row form-center form_gap">
                ...
                <div class="col-md-5">
                    <select class="form-control" name="item_type" id="purpose">
                        <option value="<?php echo $edit['item_type']; ?>">Item Type</option>
                        <option value="<?php echo $edit['item_type']; ?>">Assignment</option>
                        <option value="<?php echo $edit['item_type']; ?>">Lecture</option>
                        <option value="<?php echo $edit['item_type']; ?>">Lab</option>
                        <option value="<?php echo $edit['item_type']; ?>">Tutorial</option>
                        <option value="<?php echo $edit['item_type']; ?>">Notice</option>
                    </select>
                </div>
            </div>
