...
$list = CrudDAO::readSubjectsForLecturerSortByYearandSemester($year , $semester)
            ...
            <div>
                <table class="table table-striped">
                    ...
                    <?php foreach ($list as $key => $value) {
                        ...
                        <tr>
                            <td><?= $value['id'] ?></td>
                            <td><a href="../enroll3.php?subject_name=<?php echo $value['subject_name'] ?>&id=<?php echo $value['id']; ?>"><?= $value['subject_name'] ?></a>
                            </td>
