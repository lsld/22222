...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <h2>Edit Event Items</h2> <br/>

        <p>Fill the following details to edit event item on  the course web:</p><br/> <br/>
        ...
        $edit_event_list = CrudDAO::GetEditEvents($id);

        ?>



        <form  id="registration-form"  method="post" action="../process/editEventItemProcess.php?id=<?php echo $id; ?>" name="edit_form" role="form">
            ...
            <div class="form-group">
                ...
                <div class="input-group  col-md-5" >
                    <input type="text" name="event_title"  value="<?php  echo $edit_event_list['event_title']; ?>" class="form-control" id="" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group  col-md-5" >
                    <input type="text" name="event_place" value="<?php  echo $edit_event_list['event_place']; ?>" class="form-control" id="" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date form_datetime col-md-5" data-date="2016-09-01T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" value="<?php  echo $edit_event_list['event_start']; ?>" readonly >
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
                <input type="hidden" id="dtp_input1" name="event_start"  value="<?php  echo $edit_event_list['event_start']; ?>" required/><br/>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date form_datetime col-md-5" data-date="2016-09-01T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input2">
                    <input class="form-control" size="16" type="text" value="<?php  echo $edit_event_list['event_end']; ?>" readonly >
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
                <input type="hidden" id="dtp_input2" name="event_end"  value="<?php  echo $edit_event_list['event_end']; ?>" /><br/>
            </div>
  ...
  " name="signin" value="Add new Subject">Submit
            ...
            <div style="margin: 0 0 0 189px !important;">

                <?php

                $event_success_message = $_GET['event_success_message'];

                if ($event_success_message == 1){

                    $id = $_GET['id'];

                    $event_success_message= "Event Was Successfully Updated! ";
                    ?>


                    <p style="color: green; font-size: 14px; font-weight: 500"> <?php echo   $event_success_message ?> </p>
