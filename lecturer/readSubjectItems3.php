...
$list = CrudDAO::readSubjectItemsForEachSubject3($subject_name);
//readSubjectItemsForEachSubject3
//print_r($list); die;
...
<div id="wrapper">
    ...
    <div class="container">
        <h2>View Submitted Assignmnts.</h2>
        <p></p>
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($list as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo $value['item_url']; ?>" target="_blank">Download</a></td>
